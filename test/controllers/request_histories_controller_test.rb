...
class RequestHistoriesControllerTest < ActionController::TestCase
  ...
  test "should create request_history" do
    assert_difference('RequestHistory.count') do
      post :create, request_history: { knowledge_request_id: @request_history.knowledge_request_id, observation: @request_history.observation }
    end
  ...
  test "should update request_history" do
    patch :update, id: @request_history, request_history: { knowledge_request_id: @request_history.knowledge_request_id, observation: @request_history.observation }
    assert_redirected_to request_history_path(assigns(:request_history))
  end
