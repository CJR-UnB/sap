...
class KnowledgeRequestsControllerTest < ActionController::TestCase
  ...
  test "should create knowledge_request" do
    assert_difference('KnowledgeRequest.count') do
      post :create, knowledge_request: { knowledge_id: @knowledge_request.knowledge_id, member_id: @knowledge_request.member_id, request_status_id: @knowledge_request.request_status_id }
    end
  ...
  test "should update knowledge_request" do
    patch :update, id: @knowledge_request, knowledge_request: { knowledge_id: @knowledge_request.knowledge_id, member_id: @knowledge_request.member_id, request_status_id: @knowledge_request.request_status_id }
    assert_redirected_to knowledge_request_path(assigns(:knowledge_request))
  end
