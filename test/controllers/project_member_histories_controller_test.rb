...
class ProjectMemberHistoriesControllerTest < ActionController::TestCase
  ...
  test "should create project_member_history" do
    assert_difference('ProjectMemberHistory.count') do
      post :create, project_member_history: { member_id: @project_member_history.member_id, observation: @project_member_history.observation, project_id: @project_member_history.project_id, project_role_id: @project_member_history.project_role_id }
    end
  ...
  test "should update project_member_history" do
    patch :update, id: @project_member_history, project_member_history: { member_id: @project_member_history.member_id, observation: @project_member_history.observation, project_id: @project_member_history.project_id, project_role_id: @project_member_history.project_role_id }
    assert_redirected_to project_member_history_path(assigns(:project_member_history))
  end
