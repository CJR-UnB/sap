...
class KnowledgesControllerTest < ActionController::TestCase
  ...
  test "should create knowledge" do
    assert_difference('Knowledge.count') do
      post :create, knowledge: { description: @knowledge.description, knowledge_level_id: @knowledge.knowledge_level_id, technology_id: @knowledge.technology_id }
    end
  ...
  test "should update knowledge" do
    patch :update, id: @knowledge, knowledge: { description: @knowledge.description, knowledge_level_id: @knowledge.knowledge_level_id, technology_id: @knowledge.technology_id }
    assert_redirected_to knowledge_path(assigns(:knowledge))
  end
